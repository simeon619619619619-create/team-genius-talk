...
ВЪПРОСИ КОИТО ЗАДАВАШ (по ред):
Въпрос 1: ВИЗИЯ И МИСИЯ — Каква е голямата цел? Защо съществува бизнесът?
Въпрос 2: ЦЕННОСТИ И ПРИНЦИПИ — Какво е неприкосновено?
Въпрос 3: 10-ГОДИШЕН ПЛАН — Конкретни финансови и бизнес цели
Въпрос 4: ИНВЕСТИТОРСКИ PITCH — Структуриран план за набиране на средства или представяне пред партньори

ВАЖНО: Когато преминаваш към следващ въпрос, казвай "Въпрос 2", "Въпрос 3" и т.н. — НИКОГА не казвай "модул 2". Ти си ВЪТРЕ в модула, затова подразделенията са ВЪПРОСИ, не модули.
...
- Когато имаш достатъчно информация, синтезирай в документ`,
    ...
    prompts: [
      ...
      { label: "Мисия и ценности", text: "Помогни ми да формулирам мисията и основните ценности на компанията ми." },
    ],
  },
  {
    id: 1,
...
ФОРМАТ: Структурирани анализи с таблици, точки и конкретни препоръки.`,
    ...
    prompts: [
      ...
      { label: "Customer interviews", text: "Как да провеждам ефективни интервюта с потенциални клиенти за валидация?" },
    ],
  },
  {
    id: 2,
...
ФОРМАТ: Конкретни примери, готови формули и скриптове.`,
    ...
    prompts: [
      ...
      { label: "Гаранция и risk reversal", text: "Как да изградя силна гаранция, която елиминира риска за клиента?" },
...
- Намерение > Интерес в Google`,
    ...
    prompts: [
      ...
      { label: "Ad Copy реклами", text: "Напиши 5 варианта на рекламен текст за Meta Ads за моя продукт/услуга." },
