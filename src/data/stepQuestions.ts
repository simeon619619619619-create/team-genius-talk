...
**3. Какви са алтернативите за клиентите?**`,
  ...
  "Маркетинг стратегия": {
    ...
    botRole: "Маркетинг Стратег",
    greeting: `Страхотно! 📈 Аз съм вашият Маркетинг Стратег.

Имам информация за бизнеса, екипа и пазара от колегите. Сега трябва да определим маркетинговите и продажбените канали.

Нека започнем:

**1. Кои маркетинг канали планирате да използвате?** (Instagram, TikTok, Facebook, Email, SEO...)
**2. Кои канали за продажби до крайния клиент сте избрали?** (онлайн магазин, директни продажби, дистрибутори...)
**3. Какво е основното ви послание?**`,
    questions: [
      {
        key: "positioning",
    ...
    requiredFields: ["positioning", "marketing_channels", "sales_channels", "main_message", "lead_mechanism", "cta"],
    exitCriteria: "Има ясно позициониране, маркетинг канали и продажбени канали",
    completionMessage: "Маркетинг стратегията е ясна и подредена. Можем да преминем към оперативен план.",
    ...
    contextKeys: ["positioning", "marketing_channels", "sales_channels", "main_message", "cta"]
  },

  "Оперативен план": {
    stepTitle: "Оперативен план",
    botRole: "Оперативен Мениджър",
    greeting: `Перфектно! ⚙️ Аз съм вашият Оперативен Мениджър.
