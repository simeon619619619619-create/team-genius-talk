...
СЕДМИЧНО ПЛАНИРАНЕ (следващи 4 седмици):
...
${missingFields.length > 0 ? `ЛИПСВАЩИ ЗАДЪЛЖИТЕЛНИ ПОЛЕТА: ${missingFields.join(', ')}` : 'Всички задължителни полета са попълнени!'}
